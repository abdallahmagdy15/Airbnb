    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuestPlaceTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditExpire = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BuildingNo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreditCards_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfDaysInAdvance = table.Column<int>(type: "int", nullable: false),
                    NumberOfDaysNotice = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "PropertyGuestPlaceTypes",
                columns: table => new
                {
                    PropertyId = table.Column<int>(type: "int", nullable: false),
                    GuestPlaceTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyGuestPlaceTypes", x => new { x.PropertyId, x.GuestPlaceTypeId });
                    table.ForeignKey(
                        name: "FK_PropertyGuestPlaceTypes_GuestPlaceTypes_GuestPlaceTypeId",
                        column: x => x.GuestPlaceTypeId,
                        principalTable: "GuestPlaceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyGuestPlaceTypes_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PropertyId = table.Column<int>(type: "int", nullable: false),
                    HouseRuleId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyHouseRule", x => new { x.PropertyId, x.HouseRuleId });
                    table.ForeignKey(
                        name: "FK_PropertyHouseRule_HouseRules_HouseRuleId",
                        column: x => x.HouseRuleId,
                        principalTable: "HouseRules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyHouseRule_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertySpace", x => new { x.PropertyId, x.SpaceId });
                    table.ForeignKey(
                        name: "FK_PropertySpace_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertySpace_Spaces_SpaceId",
                        column: x => x.SpaceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyGuestPlaceTypes_GuestPlaceTypeId",
                table: "PropertyGuestPlaceTypes",
                column: "GuestPlaceTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyHouseRule_HouseRuleId",
                table: "PropertyHouseRule",
                column: "HouseRuleId");
